			...
			<div class="wrapper cf">
				...
				<ul id="nav" class="sf-menu">
					...
					<li><a href="#">WEDDING PLAN</a>
                                                <ul>
							<li><a href="packageWeddingDetailsClient.jsp">Full Package Details</a></li>
							<li><a href="decorationWeddingDetailsClient.jsp">Decoration Details</a></li>
							<li><a href="transportWeddingDetailsClient.jsp">Transport Details</a></li>
                                                        <li><a href="placeWeddingDetailsClient.jsp">Place Details</a></li>
                                                        <li><a href="foodWeddingDetailsClient.jsp">Food Details</a></li>
                                                        <li><a href="photographerWeddingDetailsClient.jsp">Photographer Details</a></li>
                                                        <li><a href="bookingWeddingClient.jsp">Booking For Wedding</a></li>
						</ul>
